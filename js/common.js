...
(function () {
  ...
  function renderFooter() {
    var bannerHtml =
      ...
      '<a href="' + BASE + 'about/piconu-city-radio.html"><img src="' + BASE + 'images/banners/banner-fm-piconu.jpg" alt="FMピコぬ「ピックアップ!ピコぬ市ラジオ」 P-800型ピコぬくんがお届けする市政広報ラジオ番組"></a>' +
      "</div></div>";
